            ...
            <div className="row" style={{ minHeight: "80vh", display: "flex", alignItems: "center" }}>
                <div className="col-md-6 offset-md-3 bg-light p-4 rounded shadow">
                    ...
                    <form onSubmit={onFormSubmit}>
                        <input onChange={onTextChange} value={formData.description} type="text" name="description" placeholder="Donating" className="form-control" />
                        <br />
                        <input onChange={onTextChange} value={formData.merit} type="text" name="merit" placeholder="In merit of" className="form-control" />
                        <br />
                        <button className="btn btn-dark"style={{backgroundColor:'#554e2b'}}>Donate</button>
                    </form>
                </div>
            </div>
        );
